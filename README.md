...
### v1.3 (当前版本) 🎉
- ✅ 优化爱企查搜索结果解析，提升注册资本、法定代表人、电话和邮箱的命中率。
- ✅ 强化爱企查自动抓取流程，保留会话建立与重试机制，提升复杂页面下的可用性。
- ✅ 新增获取过程中的“正在获取中”提示，减少等待时的空白感。
- ✅ 优化VirusTotal配置提示，未配置 API Key 时会明确提示“您还未配置VirusTotal API Key”。
- ✅ 清理无用代码与重复逻辑，提升项目维护性与稳定性。
